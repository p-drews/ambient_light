...
public class LEDConnector implements SerialPortEventListener {
    ...
    public static byte[] lastData1; 
    public static byte[] lastData2;
...
// add event listeners
    ...
    public static synchronized void sendMessage(byte[] data) throws IOException {
        //Vergleichen der Bytes damit nicht doppelt übertragen wird.
        if(Arrays.equals(lastData1, data)){
            return;
        } else if (Arrays.equals(lastData2, data)) {
            return;
        } else {
